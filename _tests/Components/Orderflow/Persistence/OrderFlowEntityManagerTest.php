...
class OrderFlowEntityManagerTest extends KernelTestCase
{
    ...
    private ShoppingCartEntityManager $cartEntityManager;
    ...
    public function testPersistOrderWithValidData(): void
    {
        ...
        $result = $orderEntityManager->persistOrder($request, $this->entityManager, $this->validation, $this->cartRepository, $this->cartEntityManager,$this->userRepository,'valid@valid.com');
